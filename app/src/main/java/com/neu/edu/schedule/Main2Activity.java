...
import com.neu.edu.schedule.adapter.MainAdapter;
import com.neu.edu.schedule.bean.SQLBean;
import com.neu.edu.schedule.data.CallAlarm;
import com.neu.edu.schedule.db.DatabaseOperation;
import com.neu.edu.schedule.doubledatepicker.DoubleDatePickerDialog;
import com.neu.edu.schedule.utils.MyGridView;
...
public class Main2Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            Intent intent = new Intent(Main2Activity.this, CallAlarm.class);//onCreate方法中先判断闹钟
            PendingIntent sender = PendingIntent.getBroadcast(
                    Main2Activity.this, 0, intent, 0);
    ...
    public void inputTitleDialog(final String lock, final int idtype,
        ...
        builder.setPositiveButton("确认", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if ("".equals(inputName)) {
                    Toast.makeText(Main2Activity.this, "密码不能为空请重新输入！",
                    ...
                    if (inputName.equals(lock)) {
                        ...
                        Toast.makeText(Main2Activity.this, "密码不正确！",
                                Toast.LENGTH_LONG).show();
                    }
                }
            }
    ...
    public void onSearch(View v) {
        ...
        if ("".equals(ek)) {//判断搜索关键词是否为空
            Toast.makeText(Main2Activity.this, "请输入关键词！", Toast.LENGTH_LONG)
                    .show();
        } else {//搜索输入不为空
            //进入搜索结果页
    ...
    public void onData(View v) {
        ...
        new DoubleDatePickerDialog(Main2Activity.this, 0,
                new DoubleDatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker startDatePicker,
                        ...
                        if (startYear < endYear || startYear == endYear
                            ...
                            Intent intent = new Intent(Main2Activity.this, DataSearchActivity.class);//跳转到日期搜索
                            ...
                            Toast.makeText(Main2Activity.this, "日期选择错误请重新选择！",
                                    Toast.LENGTH_LONG).show();
                        }
                    }
