...
import com.neu.edu.schedule.LoginActivity;
import com.neu.edu.schedule.R;
import com.neu.edu.schedule.utils.HorizontalProgressBarWithNumber;
import com.neu.edu.schedule.utils.SQLiteDBUtil;
import com.neu.edu.schedule.utils.Utility;
...
public class UserFragment extends BaseFragment implements View.OnClickListener {
    ...
    long currentCount;
    // 这个是进度条
    private com.neu.edu.schedule.utils.HorizontalProgressBarWithNumber mProgress;
    ...
    protected void initView(View view) {
        ...
        btn_exit = rootview.findViewById(R.id.btn_exit);
        btn_about_us = rootview.findViewById(R.id.btn_aboutUs);
        btn_genggaixueqi = rootview.findViewById(R.id.btn_genggaixueqi);
        mProgress = rootview.findViewById(R.id.myProgress);
        btn_count_text = rootview.findViewById(R.id.btn_count_text);
        btn_deleteAll = rootview.findViewById(R.id.btn_deleteAll);
        paomadeng = rootview.findViewById(R.id.paomadeng);

        current_accoutnt = rootview.findViewById(R.id.current_account);
